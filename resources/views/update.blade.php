        ...
        <div class="row">
            <div class="col-4">
                <div class="card cardshadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update', $updateitem->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            <input type="date" name="date" class="form-control mb-3" id="dec"
                                placeholder="Description" value="{{ $updateitem->date }}">
                            <input type="text" class="form-control mb-3" id="dec" placeholder="Description"
                                name="description" value="{{ $updateitem->description }}">
                            <input type="number" class="form-control mb-3" id="amt" placeholder="Amount"
                                name="amount" value="{{ $updateitem->amount }}">

                            @if ($updateitem->category == 1)
                            ...
                            @else
                                <select class="form-select mb-3" aria-label="Default select example" name="category">
                                    <option value="1" selected>Cash</option>
                                    <option value="2" selected>K-pay</option>
                                </select>
                            @endif
            ...
            <div class="col-8">
                <div class="card cardshadow">
                    <div class="card-header text-center text-success h5">
                        Your Daily List
                    </div>
                    <div class="card-body">
